...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            node_ = input.readMessage(com.tcn.cloud.api.api.v1alpha1.wfm.LocationNode.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.v1alpha1.wfm.CreateLocationNodeReq parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.v1alpha1.wfm.CreateLocationNodeReq) e.getUnfinishedMessage();
    ...
    public Builder mergeNode(com.tcn.cloud.api.api.v1alpha1.wfm.LocationNode value) {
      if (nodeBuilder_ == null) {
        if (node_ != null) {
          node_ =
            com.tcn.cloud.api.api.v1alpha1.wfm.LocationNode.newBuilder(node_).mergeFrom(value).buildPartial();
        } else {
          node_ = value;
        }
        onChanged();
  ...
  private static final com.google.protobuf.Parser<CreateLocationNodeReq>
    ...
    public CreateLocationNodeReq parsePartialFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new CreateLocationNodeReq(input, extensionRegistry);
    }
  };
