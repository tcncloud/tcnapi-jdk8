...
public interface DashboardPreferencesOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.org.legacy.DashboardPreferences)
   ...
   */
  com.tcn.cloud.api.api.v1alpha1.org.legacy.IncludedCallTypes getDefaultCallTypes();
  /**
   * <pre>
   * Which call types are enabled in the agents dashboard
   * </pre>
   ...
   * <code>.api.v1alpha1.org.legacy.IncludedCallTypes default_call_types = 7 [json_name = "defaultCallTypes"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.org.legacy.IncludedCallTypesOrBuilder getDefaultCallTypesOrBuilder();
   ...
   */
  com.tcn.cloud.api.api.v1alpha1.org.legacy.BargeInFiltering getDefaultBargeInFiltering();
  /**
   * <pre>
   * Barge-in agent filter, controls hunt-group and agent status parameters
   * </pre>
   ...
   * <code>.api.v1alpha1.org.legacy.BargeInFiltering default_barge_in_filtering = 9 [json_name = "defaultBargeInFiltering"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.org.legacy.BargeInFilteringOrBuilder getDefaultBargeInFilteringOrBuilder();
}
