...
/**
 * Protobuf type {@code api.v0alpha.Country}
 */
public final class Country extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:api.v0alpha.Country)
    CountryOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_Country_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.tcn.cloud.api.api.v0alpha.Country.class, com.tcn.cloud.api.api.v0alpha.Country.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.tcn.cloud.api.api.v0alpha.Country)) {
      return super.equals(obj);
    }
    com.tcn.cloud.api.api.v0alpha.Country other = (com.tcn.cloud.api.api.v0alpha.Country) obj;
  ...
  public static com.tcn.cloud.api.api.v0alpha.Country parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.Country parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.tcn.cloud.api.api.v0alpha.Country parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.Country parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.tcn.cloud.api.api.v0alpha.Country prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:api.v0alpha.Country)
      com.tcn.cloud.api.api.v0alpha.CountryOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_Country_descriptor;
    }
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.Country getDefaultInstanceForType() {
      return com.tcn.cloud.api.api.v0alpha.Country.getDefaultInstance();
    }

    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.Country build() {
      com.tcn.cloud.api.api.v0alpha.Country result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.tcn.cloud.api.api.v0alpha.Country) {
        return mergeFrom((com.tcn.cloud.api.api.v0alpha.Country)other);
      } else {
    ...
    public Builder mergeFrom(com.tcn.cloud.api.api.v0alpha.Country other) {
    ...
    // @@protoc_insertion_point(builder_scope:api.v0alpha.Country)
  }

  // @@protoc_insertion_point(class_scope:api.v0alpha.Country)
  private static final com.tcn.cloud.api.api.v0alpha.Country DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.tcn.cloud.api.api.v0alpha.Country();
  }

  public static com.tcn.cloud.api.api.v0alpha.Country getDefaultInstance() {
