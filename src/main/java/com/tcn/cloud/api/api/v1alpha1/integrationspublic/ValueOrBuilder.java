...
public interface ValueOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.integrationspublic.Value)
   ...
   * @return The compVal.
   */
  com.tcn.cloud.api.api.v1alpha1.integrationspublic.CompositeVal getCompVal();
  /**
   * <code>.api.v1alpha1.integrationspublic.CompositeVal comp_val = 6 [json_name = "compVal"];</code>
   */
