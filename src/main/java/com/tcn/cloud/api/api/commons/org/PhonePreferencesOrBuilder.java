...
public interface PhonePreferencesOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.commons.org.PhonePreferences)
   ...
   */
  com.tcn.cloud.api.api.commons.org.DialOrder getDefaultDialOrder();
  /**
   * <pre>
   * The dial order of a contact record, default 'First Number Only'.
   * </pre>
   ...
   * <code>.api.commons.org.DialOrder default_dial_order = 17 [json_name = "defaultDialOrder"];</code>
   */
  com.tcn.cloud.api.api.commons.org.DialOrderOrBuilder getDefaultDialOrderOrBuilder();
