...
public interface FieldDefinitionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.commons.integrations.FieldDefinition)
   ...
   */
  com.tcn.cloud.api.api.commons.integrations.ValueType getFieldType();
   ...
   */
  com.tcn.cloud.api.api.commons.integrations.InvoiceDisplayType getInvoiceType();
   ...
   */
  com.tcn.cloud.api.api.commons.integrations.HelperText getHelperText();
  /**
   * <pre>
   * the helper text of the field. This is the text that helps explain the label name
   * </pre>
