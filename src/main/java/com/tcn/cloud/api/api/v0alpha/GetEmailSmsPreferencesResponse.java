 ...
 * </pre>
 *
 * Protobuf type {@code api.v0alpha.GetEmailSmsPreferencesResponse}
 */
public final class GetEmailSmsPreferencesResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:api.v0alpha.GetEmailSmsPreferencesResponse)
...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_GetEmailSmsPreferencesResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse.class, com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse)) {
      return super.equals(obj);
    }
    com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse other = (com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse) obj;
  ...
  public static com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:api.v0alpha.GetEmailSmsPreferencesResponse)
      com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_GetEmailSmsPreferencesResponse_descriptor;
    }
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse getDefaultInstanceForType() {
      return com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse build() {
      com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse) {
        return mergeFrom((com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse other) {
      if (other == com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:api.v0alpha.GetEmailSmsPreferencesResponse)
  }

  // @@protoc_insertion_point(class_scope:api.v0alpha.GetEmailSmsPreferencesResponse)
  private static final com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse();
  }

  public static com.tcn.cloud.api.api.v0alpha.GetEmailSmsPreferencesResponse getDefaultInstance() {
