...
public interface GetPermissionsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.GetPermissionsResponse)
   ...
   * @return The user.
   */
  com.tcn.cloud.api.api.v0alpha.User getUser();
  /**
   * <code>.api.v0alpha.User user = 1 [json_name = "user"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.UserOrBuilder getUserOrBuilder();
