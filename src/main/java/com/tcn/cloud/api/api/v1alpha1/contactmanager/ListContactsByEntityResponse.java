...
/**
 * Protobuf type {@code api.v1alpha1.contactmanager.ListContactsByEntityResponse}
 */
public final class ListContactsByEntityResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:api.v1alpha1.contactmanager.ListContactsByEntityResponse)
    ListContactsByEntityResponseOrBuilder {
private static final long serialVersionUID = 0L;
  // Use ListContactsByEntityResponse.newBuilder() to construct.
  private ListContactsByEntityResponse(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private ListContactsByEntityResponse() {
  ...
  protected java.lang.Object newInstance(
    ...
    return new ListContactsByEntityResponse();
  }

  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.tcn.cloud.api.api.v1alpha1.contactmanager.ContactmanagerProto.internal_static_api_v1alpha1_contactmanager_ListContactsByEntityResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.tcn.cloud.api.api.v1alpha1.contactmanager.ContactmanagerProto.internal_static_api_v1alpha1_contactmanager_ListContactsByEntityResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse.class, com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse.Builder.class);
  }

  public static final int CONTACT_MANAGER_ENTRY_FIELD_NUMBER = 1;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < contactManagerEntry_.size(); i++) {
      output.writeMessage(1, contactManagerEntry_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < contactManagerEntry_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, contactManagerEntry_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse)) {
      return super.equals(obj);
    }
    com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse other = (com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse) obj;
  ...
  public static com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse parseFrom(
  ...
  public static com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse parseFrom(
  ...
  public static com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:api.v1alpha1.contactmanager.ListContactsByEntityResponse)
      com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.tcn.cloud.api.api.v1alpha1.contactmanager.ContactmanagerProto.internal_static_api_v1alpha1_contactmanager_ListContactsByEntityResponse_descriptor;
    }
    ...
    // Construct using com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse getDefaultInstanceForType() {
      return com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse build() {
      com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse buildPartial() {
      com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse result = new com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse(this);
    ...
    private void buildPartialRepeatedFields(com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse result) {
      if (contactManagerEntryBuilder_ == null) {
    ...
    private void buildPartial0(com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse) {
        return mergeFrom((com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse other) {
      if (other == com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse.getDefaultInstance()) return this;
      if (contactManagerEntryBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:api.v1alpha1.contactmanager.ListContactsByEntityResponse)
  }

  // @@protoc_insertion_point(class_scope:api.v1alpha1.contactmanager.ListContactsByEntityResponse)
  private static final com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse();
  }

  public static com.tcn.cloud.api.api.v1alpha1.contactmanager.ListContactsByEntityResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<ListContactsByEntityResponse>
      PARSER = new com.google.protobuf.AbstractParser<ListContactsByEntityResponse>() {
    @java.lang.Override
    public ListContactsByEntityResponse parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
  ...
  public static com.google.protobuf.Parser<ListContactsByEntityResponse> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<ListContactsByEntityResponse> getParserForType() {
    return PARSER;
  }
