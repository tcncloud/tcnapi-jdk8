...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.tcn.cloud.api.api.v0alpha.LogEvent.Builder subBuilder = null;
            if (eventCase_ == 1) {
              subBuilder = ((com.tcn.cloud.api.api.v0alpha.LogEvent) event_).toBuilder();
            }
            event_ =
                input.readMessage(com.tcn.cloud.api.api.v0alpha.LogEvent.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.tcn.cloud.api.api.v0alpha.LogEvent) event_);
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.v0alpha.SentinelEvent parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.v0alpha.SentinelEvent) e.getUnfinishedMessage();
