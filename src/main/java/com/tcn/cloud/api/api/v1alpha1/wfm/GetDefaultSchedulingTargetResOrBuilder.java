...
public interface GetDefaultSchedulingTargetResOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.wfm.GetDefaultSchedulingTargetRes)
