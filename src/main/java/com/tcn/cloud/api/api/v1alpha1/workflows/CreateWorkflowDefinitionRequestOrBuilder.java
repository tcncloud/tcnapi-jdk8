...
public interface CreateWorkflowDefinitionRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.workflows.CreateWorkflowDefinitionRequest)
