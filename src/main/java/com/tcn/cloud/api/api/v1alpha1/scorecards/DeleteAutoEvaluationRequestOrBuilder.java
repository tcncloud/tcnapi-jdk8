...
public interface DeleteAutoEvaluationRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.scorecards.DeleteAutoEvaluationRequest)
