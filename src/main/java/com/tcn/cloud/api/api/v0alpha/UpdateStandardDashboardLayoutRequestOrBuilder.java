...
public interface UpdateStandardDashboardLayoutRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.UpdateStandardDashboardLayoutRequest)
