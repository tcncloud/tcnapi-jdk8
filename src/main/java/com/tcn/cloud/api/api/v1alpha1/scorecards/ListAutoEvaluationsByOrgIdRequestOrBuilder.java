...
public interface ListAutoEvaluationsByOrgIdRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.scorecards.ListAutoEvaluationsByOrgIdRequest)
   ...
   * @return The callSid.
   */
  com.tcn.cloud.api.api.v1alpha1.scorecards.ListAutoEvaluationsByOrgIdRequest.CallSidFilter getCallSid();
  /**
   * <pre>
   * Optional - filter by call sid.
   * </pre>
   ...
   * <code>.api.v1alpha1.scorecards.ListAutoEvaluationsByOrgIdRequest.CallSidFilter call_sid = 6 [json_name = "callSid"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.scorecards.ListAutoEvaluationsByOrgIdRequest.CallSidFilterOrBuilder getCallSidOrBuilder();
