...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              entities_ = new java.util.ArrayList<com.tcn.cloud.api.api.v1alpha1.delivery.Credential>();
              mutable_bitField0_ |= 0x00000001;
            }
            entities_.add(
                input.readMessage(com.tcn.cloud.api.api.v1alpha1.delivery.Credential.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.v1alpha1.delivery.Credentials parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.v1alpha1.delivery.Credentials) e.getUnfinishedMessage();
