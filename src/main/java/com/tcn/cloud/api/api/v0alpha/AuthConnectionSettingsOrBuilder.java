...
public interface AuthConnectionSettingsOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.AuthConnectionSettings)
   ...
   */
  com.tcn.cloud.api.api.v0alpha.AuthConnectionSettings.SecretExpiration getSecretExpiration();
  /**
   * <pre>
   * secret_expiration is an optional field that is
   * used to know when the connection's secret will
   ...
   * <code>.api.v0alpha.AuthConnectionSettings.SecretExpiration secret_expiration = 10 [json_name = "secretExpiration"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.AuthConnectionSettings.SecretExpirationOrBuilder getSecretExpirationOrBuilder();
   ...
   */
  com.tcn.cloud.api.api.v0alpha.GroupItem getDefaultGroup();
  /**
   * <pre>
   * default_group defines settings used for all users for this connection
   * regardless of their groups. Group name is ignored for the default. This
   ...
   * <code>.api.v0alpha.GroupItem default_group = 12 [json_name = "defaultGroup"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.GroupItemOrBuilder getDefaultGroupOrBuilder();
   ...
   */
  java.util.List<com.tcn.cloud.api.api.v0alpha.GroupItem> 
      getCustomGroupsList();
  /**
   * <pre>
   * custom_groups defines the settings that will be used if a user with
   ...
   * <code>repeated .api.v0alpha.GroupItem custom_groups = 13 [json_name = "customGroups"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.GroupItem getCustomGroups(int index);
  /**
   * <pre>
   * custom_groups defines the settings that will be used if a user with
   * this connection contains one or more of the matching group names.
   ...
   * <code>repeated .api.v0alpha.GroupItem custom_groups = 13 [json_name = "customGroups"];</code>
   */
  java.util.List<? extends com.tcn.cloud.api.api.v0alpha.GroupItemOrBuilder> 
   ...
   * <code>repeated .api.v0alpha.GroupItem custom_groups = 13 [json_name = "customGroups"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.GroupItemOrBuilder getCustomGroupsOrBuilder(
      int index);
}
