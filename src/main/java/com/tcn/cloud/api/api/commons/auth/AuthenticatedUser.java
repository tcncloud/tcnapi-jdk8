...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.tcn.cloud.api.api.commons.auth.AuthClaims.Builder subBuilder = null;
            if (claims_ != null) {
              subBuilder = claims_.toBuilder();
            }
            claims_ = input.readMessage(com.tcn.cloud.api.api.commons.auth.AuthClaims.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.commons.auth.AuthenticatedUser parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.commons.auth.AuthenticatedUser) e.getUnfinishedMessage();
    ...
    public Builder mergeClaims(com.tcn.cloud.api.api.commons.auth.AuthClaims value) {
      if (claimsBuilder_ == null) {
        if (claims_ != null) {
          claims_ =
            com.tcn.cloud.api.api.commons.auth.AuthClaims.newBuilder(claims_).mergeFrom(value).buildPartial();
        } else {
          claims_ = value;
        }
        onChanged();
