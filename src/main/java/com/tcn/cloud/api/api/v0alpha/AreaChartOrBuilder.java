...
public interface AreaChartOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.AreaChart)
   ...
   * @return The areaType.
   */
  com.tcn.cloud.api.api.commons.AreaChartChoice getAreaType();
}
