...
public interface ColumnReplacementOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.explorer.ColumnReplacement)
   ...
   */
  java.util.List<com.tcn.cloud.api.api.v1alpha1.explorer.ValuesReplacement> 
   ...
   * <code>repeated .api.v1alpha1.explorer.ValuesReplacement values_replacements = 2 [json_name = "valuesReplacements"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.explorer.ValuesReplacement getValuesReplacements(int index);
  /**
   * <pre>
   * Values to replace
   * </pre>
   ...
   * <code>repeated .api.v1alpha1.explorer.ValuesReplacement values_replacements = 2 [json_name = "valuesReplacements"];</code>
   */
  java.util.List<? extends com.tcn.cloud.api.api.v1alpha1.explorer.ValuesReplacementOrBuilder> 
   ...
   * <code>repeated .api.v1alpha1.explorer.ValuesReplacement values_replacements = 2 [json_name = "valuesReplacements"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.explorer.ValuesReplacementOrBuilder getValuesReplacementsOrBuilder(
      int index);
}
