...
private static final long serialVersionUID = 0L;
  ...
  public interface TotpTypeOrBuilder extends
     ...
     * </pre>
     *
     * <code>.api.commons.org.TotpAuthenticatorType authenticator_type = 1 [json_name = "authenticatorType"];</code>
     * @return The enum numeric value on the wire for authenticatorType.
     */
    int getAuthenticatorTypeValue();
    /**
     * <pre>
     * The type of authenticator app that is being used.
     * </pre>
     ...
     */
    com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType getAuthenticatorType();

    /**
     * <pre>
     * The secreate key that is generated when the user sets up the authenticator.
     * </pre>
     *
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AUTHENTICATOR_TYPE_FIELD_NUMBER = 1;
     ...
     * @return The enum numeric value on the wire for authenticatorType.
     */
    @java.lang.Override public int getAuthenticatorTypeValue() {
     ...
     * @return The authenticatorType.
     */
    @java.lang.Override public com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType getAuthenticatorType() {
      com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType result = com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType.forNumber(authenticatorType_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (authenticatorType_ != com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType.TOTP_AUTHENTICATOR_TYPE_UNSPECIFIED.getNumber()) {
        output.writeEnum(1, authenticatorType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (authenticatorType_ != com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType.TOTP_AUTHENTICATOR_TYPE_UNSPECIFIED.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(1, authenticatorType_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(secretKey_)) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (authenticatorType_ != other.authenticatorType_) return false;
      if (!getSecretKey()
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + authenticatorType_;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(com.tcn.cloud.api.api.commons.org.MfaInfo.TotpType other) {
        ...
        if (other.authenticatorType_ != 0) {
          setAuthenticatorTypeValue(other.getAuthenticatorTypeValue());
        }
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 8: {
                authenticatorType_ = input.readEnum();
                bitField0_ |= 0x00000001;
                break;
              } // case 8
              case 18: {
       ...
       *
       * <code>.api.commons.org.TotpAuthenticatorType authenticator_type = 1 [json_name = "authenticatorType"];</code>
       * @param value The enum numeric value on the wire for authenticatorType to set.
       * @return This builder for chaining.
       */
      public Builder setAuthenticatorTypeValue(int value) {
       ...
       */
      @java.lang.Override
      public com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType getAuthenticatorType() {
        com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType result = com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType.forNumber(authenticatorType_);
        return result == null ? com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setAuthenticatorType(com.tcn.cloud.api.api.commons.org.TotpAuthenticatorType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000001;
        authenticatorType_ = value.getNumber();
        onChanged();
        return this;
      }
      /**
