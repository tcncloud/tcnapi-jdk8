...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.tcn.cloud.api.api.v1alpha1.vanalytics.TimestampRange.Builder subBuilder = null;
            if (whereCase_ == 1) {
              subBuilder = ((com.tcn.cloud.api.api.v1alpha1.vanalytics.TimestampRange) where_).toBuilder();
            }
            where_ =
                input.readMessage(com.tcn.cloud.api.api.v1alpha1.vanalytics.TimestampRange.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.tcn.cloud.api.api.v1alpha1.vanalytics.TimestampRange) where_);
          ...
          case 18: {
            com.tcn.cloud.api.api.v1alpha1.vanalytics.Moment.Builder subBuilder = null;
            if (whereCase_ == 2) {
              subBuilder = ((com.tcn.cloud.api.api.v1alpha1.vanalytics.Moment) where_).toBuilder();
            }
            where_ =
                input.readMessage(com.tcn.cloud.api.api.v1alpha1.vanalytics.Moment.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.tcn.cloud.api.api.v1alpha1.vanalytics.Moment) where_);
              where_ = subBuilder.buildPartial();
            }
            whereCase_ = 2;
            break;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.v1alpha1.vanalytics.TimestampExpr parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.v1alpha1.vanalytics.TimestampExpr) e.getUnfinishedMessage();
  ...
  private static final com.google.protobuf.Parser<TimestampExpr>
    ...
    public TimestampExpr parsePartialFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new TimestampExpr(input, extensionRegistry);
    }
  };
