...
public final class ServiceProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "category:\001*\022\312\001\n\022CreateAutoQuestion\0222.api" +
      ".v1alpha1.scorecards.CreateAutoQuestionR" +
      "equest\0323.api.v1alpha1.scorecards.CreateA" +
      "utoQuestionResponse\"K\272\270\221\002\005\n\003\010\301\014\202\323\344\223\002;\"6/" +
      "api/v1alpha1/scorecards/scorecards/creat" +
      "eautoquestion:\001*\022\312\001\n\022UpdateAutoQuestion\022" +
      "2.api.v1alpha1.scorecards.UpdateAutoQues" +
      "tionRequest\0323.api.v1alpha1.scorecards.Up" +
      "dateAutoQuestionResponse\"K\272\270\221\002\005\n\003\010\301\014\202\323\344\223" +
      "\002;\"6/api/v1alpha1/scorecards/scorecards/" +
      "updateautoquestion:\001*\022\312\001\n\022DeleteAutoQues" +
      "tion\0222.api.v1alpha1.scorecards.DeleteAut" +
      "oQuestionRequest\0323.api.v1alpha1.scorecar" +
      "ds.DeleteAutoQuestionResponse\"K\272\270\221\002\005\n\003\010\301" +
      "\014\202\323\344\223\002;\"6/api/v1alpha1/scorecards/scorec" +
      "ards/deleteautoquestion:\001*\022\276\001\n\017GetAutoQu" +
      "estion\022/.api.v1alpha1.scorecards.GetAuto" +
      "QuestionRequest\0320.api.v1alpha1.scorecard" +
      "s.GetAutoQuestionResponse\"H\272\270\221\002\005\n\003\010\301\014\202\323\344" +
      "\223\0028\"3/api/v1alpha1/scorecards/scorecards" +
      "/getautoquestion:\001*\022\306\001\n\021GetAutoEvaluatio" +
      "n\0221.api.v1alpha1.scorecards.GetAutoEvalu" +
      "ationRequest\0322.api.v1alpha1.scorecards.G" +
      "etAutoEvaluationResponse\"J\272\270\221\002\005\n\003\010\302\014\202\323\344\223" +
      "\002:\"5/api/v1alpha1/scorecards/scorecards/" +
      "getautoevaluation:\001*\022\316\001\n\023ListAutoEvaluat" +
      "ions\0223.api.v1alpha1.scorecards.ListAutoE" +
      "valuationsRequest\0324.api.v1alpha1.scoreca" +
      "rds.ListAutoEvaluationsResponse\"L\272\270\221\002\005\n\003" +
      "\010\302\014\202\323\344\223\002<\"7/api/v1alpha1/scorecards/scor" +
      "ecards/listautoevaluations:\001*\022\330\001\n\025Stream" +
      "AutoEvaluations\0225.api.v1alpha1.scorecard" +
      "s.StreamAutoEvaluationsRequest\0326.api.v1a" +
      "lpha1.scorecards.StreamAutoEvaluationsRe" +
      "sponse\"N\272\270\221\002\005\n\003\010\302\014\202\323\344\223\002>\"9/api/v1alpha1/" +
      "scorecards/scorecards/streamautoevaluati" +
      "ons:\001*0\001\022\322\001\n\024DeleteAutoEvaluation\0224.api." +
      "v1alpha1.scorecards.DeleteAutoEvaluation" +
      "Request\0325.api.v1alpha1.scorecards.Delete" +
      "AutoEvaluationResponse\"M\272\270\221\002\005\n\003\010\302\014\202\323\344\223\002=" +
      "\"8/api/v1alpha1/scorecards/scorecards/de" +
      "leteautoevaluation:\001*\022\332\001\n\026PreviewEvaluat" +
      "ionScore\0226.api.v1alpha1.scorecards.Previ" +
      "ewEvaluationScoreRequest\0327.api.v1alpha1." +
      "scorecards.PreviewEvaluationScoreRespons" +
      "e\"O\272\270\221\002\005\n\003\010\302\014\202\323\344\223\002?\":/api/v1alpha1/score" +
      "cards/scorecards/previewevaluationscore:" +
      "\001*\022\306\001\n\021RestoreEvaluation\0221.api.v1alpha1." +
      "scorecards.RestoreEvaluationRequest\0322.ap" +
      "i.v1alpha1.scorecards.RestoreEvaluationR" +
      "esponse\"J\272\270\221\002\005\n\003\010\302\014\202\323\344\223\002:\"5/api/v1alpha1" +
      "/scorecards/scorecards/restoreevaluation" +
      ":\001*\022\316\001\n\023CreateSmartQuestion\0223.api.v1alph" +
      "a1.scorecards.CreateSmartQuestionRequest" +
      "\0324.api.v1alpha1.scorecards.CreateSmartQu" +
      "estionResponse\"L\272\270\221\002\005\n\003\010\301\014\202\323\344\223\002<\"7/api/v" +
      "1alpha1/scorecards/scorecards/createsmar" +
      "tquestion:\001*\022\316\001\n\023UpdateSmartQuestion\0223.a" +
      "pi.v1alpha1.scorecards.UpdateSmartQuesti" +
      "onRequest\0324.api.v1alpha1.scorecards.Upda" +
      "teSmartQuestionResponse\"L\272\270\221\002\005\n\003\010\301\014\202\323\344\223\002" +
      "<\"7/api/v1alpha1/scorecards/scorecards/u" +
      "pdatesmartquestion:\001*\022\316\001\n\023DeleteSmartQue" +
      "stion\0223.api.v1alpha1.scorecards.DeleteSm" +
      "artQuestionRequest\0324.api.v1alpha1.scorec" +
      "ards.DeleteSmartQuestionResponse\"L\272\270\221\002\005\n" +
      "\003\010\301\014\202\323\344\223\002<\"7/api/v1alpha1/scorecards/sco" +
      "recards/deletesmartquestion:\001*\022\322\001\n\024ListS" +
      "martEvaluations\0224.api.v1alpha1.scorecard" +
      "s.ListSmartEvaluationsRequest\0325.api.v1al" +
      "pha1.scorecards.ListSmartEvaluationsResp" +
      "onse\"M\272\270\221\002\005\n\003\010\302\014\202\323\344\223\002=\"8/api/v1alpha1/sc" +
      "orecards/scorecards/listsmartevaluations" +
      ":\001*\022\326\001\n\025DeleteSmartEvaluation\0225.api.v1al" +
      "pha1.scorecards.DeleteSmartEvaluationReq" +
      "uest\0326.api.v1alpha1.scorecards.DeleteSma" +
      "rtEvaluationResponse\"N\272\270\221\002\005\n\003\010\302\014\202\323\344\223\002>\"9" +
      "/api/v1alpha1/scorecards/scorecards/dele" +
      "tesmartevaluation:\001*\022\312\001\n\022GetSmartEvaluat" +
      "ion\0222.api.v1alpha1.scorecards.GetSmartEv" +
      "aluationRequest\0323.api.v1alpha1.scorecard" +
      "s.GetSmartEvaluationResponse\"K\272\270\221\002\005\n\003\010\302\014" +
      "\202\323\344\223\002;\"6/api/v1alpha1/scorecards/scoreca" +
      "rds/getsmartevaluation:\001*B\267\001\n)com.tcn.cl" +
      "oud.api.api.v1alpha1.scorecardsB\014Service" +
