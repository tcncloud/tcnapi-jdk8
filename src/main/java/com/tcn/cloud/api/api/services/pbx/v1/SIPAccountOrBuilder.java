...
public interface SIPAccountOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.services.pbx.v1.SIPAccount)
   ...
   * <code>repeated .api.services.pbx.v1.RingGroup ring_groups = 4 [json_name = "ringGroups"];</code>
   */
  com.tcn.cloud.api.api.services.pbx.v1.RingGroup getRingGroups(int index);
  /**
   * <code>repeated .api.services.pbx.v1.RingGroup ring_groups = 4 [json_name = "ringGroups"];</code>
   */
   ...
   * <code>repeated .api.services.pbx.v1.RingGroup ring_groups = 4 [json_name = "ringGroups"];</code>
   */
  com.tcn.cloud.api.api.services.pbx.v1.RingGroupOrBuilder getRingGroupsOrBuilder(
      int index);
}
