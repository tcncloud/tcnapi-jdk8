...
public interface CompliancePreferencesOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.CompliancePreferences)
   ...
   */
  com.tcn.cloud.api.api.v0alpha.ScheduleRuleField getDefaultScheduleRule();
  /**
   * <pre>
   * Default Schedule Rule
   * </pre>
   ...
   * <code>.api.v0alpha.ScheduleRuleField default_schedule_rule = 19 [json_name = "defaultScheduleRule"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.ScheduleRuleFieldOrBuilder getDefaultScheduleRuleOrBuilder();
   ...
   */
  com.tcn.cloud.api.api.v0alpha.ZipCodeField getZipCodeScrub();
  /**
   * <pre>
   * Zip code scrub attribute
   * </pre>
   ...
   * <code>.api.v0alpha.ZipCodeField zip_code_scrub = 21 [json_name = "zipCodeScrub"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.ZipCodeFieldOrBuilder getZipCodeScrubOrBuilder();
