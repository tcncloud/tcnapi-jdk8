...
public final class PortalManagerApiGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq,
      com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes> getClonePluginInstanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ClonePluginInstance",
      requestType = com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq.class,
      responseType = com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq,
      com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes> getClonePluginInstanceMethod() {
    io.grpc.MethodDescriptor<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq, com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes> getClonePluginInstanceMethod;
    if ((getClonePluginInstanceMethod = PortalManagerApiGrpc.getClonePluginInstanceMethod) == null) {
      synchronized (PortalManagerApiGrpc.class) {
        if ((getClonePluginInstanceMethod = PortalManagerApiGrpc.getClonePluginInstanceMethod) == null) {
          PortalManagerApiGrpc.getClonePluginInstanceMethod = getClonePluginInstanceMethod =
              io.grpc.MethodDescriptor.<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq, com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ClonePluginInstance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes.getDefaultInstance()))
              .setSchemaDescriptor(new PortalManagerApiMethodDescriptorSupplier("ClonePluginInstance"))
              .build();
        }
      }
    }
    return getClonePluginInstanceMethod;
  }
  ...
  private static volatile io.grpc.MethodDescriptor<com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq,
      com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse> getListAllActionDefinitionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListAllActionDefinitions",
      requestType = com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq.class,
      responseType = com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq,
      com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse> getListAllActionDefinitionsMethod() {
    io.grpc.MethodDescriptor<com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq, com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse> getListAllActionDefinitionsMethod;
    if ((getListAllActionDefinitionsMethod = PortalManagerApiGrpc.getListAllActionDefinitionsMethod) == null) {
      synchronized (PortalManagerApiGrpc.class) {
        if ((getListAllActionDefinitionsMethod = PortalManagerApiGrpc.getListAllActionDefinitionsMethod) == null) {
          PortalManagerApiGrpc.getListAllActionDefinitionsMethod = getListAllActionDefinitionsMethod =
              io.grpc.MethodDescriptor.<com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq, com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListAllActionDefinitions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new PortalManagerApiMethodDescriptorSupplier("ListAllActionDefinitions"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void clonePluginInstance(com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq request,
        io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getClonePluginInstanceMethod(), responseObserver);
    }
  ...
  public static final class PortalManagerApiStub
    ...
    /**
     */
    public void clonePluginInstance(com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq request,
        io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getClonePluginInstanceMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    /**
     */
    public void listAllActionDefinitions(com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq request,
        io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class PortalManagerApiBlockingStub
    ...
    /**
     */
    public com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes clonePluginInstance(com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getClonePluginInstanceMethod(), getCallOptions(), request);
    }
  ...
  public static final class PortalManagerApiFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes> clonePluginInstance(
        com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getClonePluginInstanceMethod(), getCallOptions()), request);
    }
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsResponse> listAllActionDefinitions(
        com.tcn.cloud.api.api.v1alpha1.integrations.ListAllActionDefinitionsReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_CLONE_PLUGIN_INSTANCE = 19;
      ...
      switch (methodId) {
        ...
        case METHODID_DELETE_PLUGIN_INSTANCE:
          serviceImpl.deletePluginInstance((com.tcn.cloud.api.api.v1alpha1.integrations.DeletePluginInstanceReq) request,
              (io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.v1alpha1.integrations.DeletePluginInstanceRes>) responseObserver);
          break;
        case METHODID_CLONE_PLUGIN_INSTANCE:
          serviceImpl.clonePluginInstance((com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq) request,
              (io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes>) responseObserver);
          break;
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          getClonePluginInstanceMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceReq,
              com.tcn.cloud.api.api.v1alpha1.integrations.ClonePluginInstanceRes>(
                service, METHODID_CLONE_PLUGIN_INSTANCE)))
        .addMethod(
        ...
        .addMethod(
          getListAllActionDefinitionsMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
      ...
      synchronized (PortalManagerApiGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getClonePluginInstanceMethod())
