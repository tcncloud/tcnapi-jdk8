 ...
 * </pre>
 *
 * Protobuf type {@code api.v0alpha.UpdatePhonePreferencesRequest}
 */
public final class UpdatePhonePreferencesRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:api.v0alpha.UpdatePhonePreferencesRequest)
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 18: {
            com.tcn.cloud.api.api.v0alpha.PhonePreferences.Builder subBuilder = null;
            if (phonePreferences_ != null) {
              subBuilder = phonePreferences_.toBuilder();
            }
            phonePreferences_ = input.readMessage(com.tcn.cloud.api.api.v0alpha.PhonePreferences.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_UpdatePhonePreferencesRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_UpdatePhonePreferencesRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest.class, com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest)) {
      return super.equals(obj);
    }
    com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest other = (com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest) obj;
  ...
  public static com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:api.v0alpha.UpdatePhonePreferencesRequest)
      com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_UpdatePhonePreferencesRequest_descriptor;
    }
    ...
    // Construct using com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest getDefaultInstanceForType() {
      return com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest.getDefaultInstance();
    }

    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest build() {
      com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest result = buildPartial();
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest buildPartial() {
      com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest result = new com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest(this);
      if (phonePreferencesBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest) {
        return mergeFrom((com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest)other);
      } else {
    ...
    public Builder mergeFrom(com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest other) {
      if (other == com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest) e.getUnfinishedMessage();
    ...
    public Builder mergePhonePreferences(com.tcn.cloud.api.api.v0alpha.PhonePreferences value) {
      if (phonePreferencesBuilder_ == null) {
        if (phonePreferences_ != null) {
          phonePreferences_ =
            com.tcn.cloud.api.api.v0alpha.PhonePreferences.newBuilder(phonePreferences_).mergeFrom(value).buildPartial();
        } else {
          phonePreferences_ = value;
        }
        onChanged();
    ...
    // @@protoc_insertion_point(builder_scope:api.v0alpha.UpdatePhonePreferencesRequest)
  }

  // @@protoc_insertion_point(class_scope:api.v0alpha.UpdatePhonePreferencesRequest)
  private static final com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest();
  }

  public static com.tcn.cloud.api.api.v0alpha.UpdatePhonePreferencesRequest getDefaultInstance() {
