...
public interface RegisterOrganizationRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.RegisterOrganizationRequest)
   ...
   */
  com.tcn.cloud.api.api.v0alpha.Organization getOrganization();
  /**
   * <code>.api.v0alpha.Organization organization = 1 [json_name = "organization"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.OrganizationOrBuilder getOrganizationOrBuilder();
