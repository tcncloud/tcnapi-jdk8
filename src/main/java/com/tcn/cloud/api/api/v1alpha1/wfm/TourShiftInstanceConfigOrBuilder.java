...
public interface TourShiftInstanceConfigOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.wfm.TourShiftInstanceConfig)
   ...
   * <code>repeated .api.v1alpha1.wfm.TourShiftSegmentConfig member_tour_shift_segment_configs = 5 [json_name = "memberTourShiftSegmentConfigs"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.wfm.TourShiftSegmentConfig getMemberTourShiftSegmentConfigs(int index);
  /**
   * <pre>
   * The tour shift segment configs that are associated with &#64;tour_shift_instance_config_sid.
   * </pre>
   ...
   * <code>repeated .api.v1alpha1.wfm.TourShiftSegmentConfig member_tour_shift_segment_configs = 5 [json_name = "memberTourShiftSegmentConfigs"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.wfm.TourShiftSegmentConfigOrBuilder getMemberTourShiftSegmentConfigsOrBuilder(
      int index);
}
