...
private static final long serialVersionUID = 0L;
  ...
  public static final int CONTACT_ENTRY_ID_FIELD_NUMBER = 5;
  private long contactEntryId_ = 0L;
  /**
   * <code>int64 contact_entry_id = 5 [json_name = "contactEntryId", jstype = JS_STRING];</code>
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (contactEntryId_ != 0L) {
      output.writeInt64(5, contactEntryId_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (contactEntryId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(5, contactEntryId_);
    }
