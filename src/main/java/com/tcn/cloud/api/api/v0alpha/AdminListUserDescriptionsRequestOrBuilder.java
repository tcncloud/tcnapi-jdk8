...
public interface AdminListUserDescriptionsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.AdminListUserDescriptionsRequest)
