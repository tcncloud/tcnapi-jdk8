...
public interface GetUserSessionDataResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.org.users.GetUserSessionDataResponse)
   ...
   * @return The user.
   */
  com.tcn.cloud.api.api.v1alpha1.org.users.GetUserSessionDataResponse.User getUser();
  /**
   * <pre>
   * The user the data is about
   * </pre>
   ...
   * <code>.api.v1alpha1.org.users.GetUserSessionDataResponse.User user = 1 [json_name = "user"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.org.users.GetUserSessionDataResponse.UserOrBuilder getUserOrBuilder();
