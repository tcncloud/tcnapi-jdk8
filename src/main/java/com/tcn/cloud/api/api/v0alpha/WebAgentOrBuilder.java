...
public interface WebAgentOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.WebAgent)
   ...
   * @return The openSips.
   */
  com.tcn.cloud.api.api.v0alpha.WebAgent.OpenSips getOpenSips();
  /**
   * <code>.api.v0alpha.WebAgent.OpenSips open_sips = 1 [json_name = "openSips"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.WebAgent.OpenSipsOrBuilder getOpenSipsOrBuilder();
   ...
   */
  com.tcn.cloud.api.api.v0alpha.WebAgent.EnginePriority getEnginePriority();
  /**
   * <code>.api.v0alpha.WebAgent.EnginePriority engine_priority = 2 [json_name = "enginePriority"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.WebAgent.EnginePriorityOrBuilder getEnginePriorityOrBuilder();
   ...
   * @return The server.
   */
  com.tcn.cloud.api.api.v0alpha.WebAgent.Server getServer();
  /**
   * <code>.api.v0alpha.WebAgent.Server server = 10 [json_name = "server"];</code>
   */
  com.tcn.cloud.api.api.v0alpha.WebAgent.ServerOrBuilder getServerOrBuilder();
