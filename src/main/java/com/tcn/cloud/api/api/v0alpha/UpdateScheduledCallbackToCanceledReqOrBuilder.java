...
public interface UpdateScheduledCallbackToCanceledReqOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.UpdateScheduledCallbackToCanceledReq)
