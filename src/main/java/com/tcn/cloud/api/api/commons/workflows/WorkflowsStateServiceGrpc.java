...
public final class WorkflowsStateServiceGrpc {
  ...
  public static final String SERVICE_NAME = "api.commons.workflows.WorkflowsStateService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest,
      com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse> getSaveFlowStateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SaveFlowState",
      requestType = com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest.class,
      responseType = com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest,
      com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse> getSaveFlowStateMethod() {
    io.grpc.MethodDescriptor<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest, com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse> getSaveFlowStateMethod;
      ...
      synchronized (WorkflowsStateServiceGrpc.class) {
        if ((getSaveFlowStateMethod = WorkflowsStateServiceGrpc.getSaveFlowStateMethod) == null) {
          WorkflowsStateServiceGrpc.getSaveFlowStateMethod = getSaveFlowStateMethod =
              io.grpc.MethodDescriptor.<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest, com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SaveFlowState"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest,
      com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse> getGetFlowStateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFlowState",
      requestType = com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest.class,
      responseType = com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest,
      com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse> getGetFlowStateMethod() {
    io.grpc.MethodDescriptor<com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest, com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse> getGetFlowStateMethod;
      ...
      synchronized (WorkflowsStateServiceGrpc.class) {
        if ((getGetFlowStateMethod = WorkflowsStateServiceGrpc.getGetFlowStateMethod) == null) {
          WorkflowsStateServiceGrpc.getGetFlowStateMethod = getGetFlowStateMethod =
              io.grpc.MethodDescriptor.<com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest, com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFlowState"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void saveFlowState(com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest request,
        io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSaveFlowStateMethod(), responseObserver);
    }

    /**
     */
    default void getFlowState(com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest request,
        io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse> responseObserver) {
  ...
  public static final class WorkflowsStateServiceStub
    ...
    /**
     */
    public void saveFlowState(com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest request,
        io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse> responseObserver) {
    ...
    /**
     */
    public void getFlowState(com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest request,
        io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class WorkflowsStateServiceBlockingStub
    ...
    /**
     */
    public com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse saveFlowState(com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest request) {
    ...
    /**
     */
    public com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse getFlowState(com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class WorkflowsStateServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse> saveFlowState(
        com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse> getFlowState(
        com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetFlowStateMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_SAVE_FLOW_STATE = 0;
  private static final int METHODID_GET_FLOW_STATE = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAVE_FLOW_STATE:
          serviceImpl.saveFlowState((com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest) request,
              (io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse>) responseObserver);
          break;
        case METHODID_GET_FLOW_STATE:
          serviceImpl.getFlowState((com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest) request,
              (io.grpc.stub.StreamObserver<com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.tcn.cloud.api.api.commons.workflows.SaveFlowStateRequest,
              com.tcn.cloud.api.api.commons.workflows.SaveFlowStateResponse>(
                service, METHODID_SAVE_FLOW_STATE)))
        .addMethod(
          getGetFlowStateMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.tcn.cloud.api.api.commons.workflows.GetFlowStateRequest,
              com.tcn.cloud.api.api.commons.workflows.GetFlowStateResponse>(
