...
public interface GetDeliveryDefinitionByNameResOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.delivery.GetDeliveryDefinitionByNameRes)
