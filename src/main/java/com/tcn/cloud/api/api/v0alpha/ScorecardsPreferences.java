...
/**
 * Protobuf type {@code api.v0alpha.ScorecardsPreferences}
 */
public final class ScorecardsPreferences extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:api.v0alpha.ScorecardsPreferences)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_ScorecardsPreferences_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_ScorecardsPreferences_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences.class, com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences.Builder.class);
  }
   ...
   */
  @java.lang.Override public com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval getEvaluationInterval() {
    @SuppressWarnings("deprecation")
    com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval result = com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval.valueOf(evaluationInterval_);
    return result == null ? com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (evaluationInterval_ != com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval.DAY.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences)) {
      return super.equals(obj);
    }
    com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences other = (com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences) obj;
  ...
  public static com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences parseFrom(
  ...
  public static com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:api.v0alpha.ScorecardsPreferences)
      com.tcn.cloud.api.api.v0alpha.ScorecardsPreferencesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.tcn.cloud.api.api.v0alpha.OrgProto.internal_static_api_v0alpha_ScorecardsPreferences_descriptor;
    }
    ...
    // Construct using com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences getDefaultInstanceForType() {
      return com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences.getDefaultInstance();
    }

    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences build() {
      com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences result = buildPartial();
    ...
    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences buildPartial() {
      com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences result = new com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences) {
        return mergeFrom((com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences)other);
      } else {
    ...
    public Builder mergeFrom(com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences other) {
      if (other == com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences) e.getUnfinishedMessage();
     ...
     */
    @java.lang.Override
    public com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval getEvaluationInterval() {
      @SuppressWarnings("deprecation")
      com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval result = com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval.valueOf(evaluationInterval_);
      return result == null ? com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setEvaluationInterval(com.tcn.cloud.api.api.v0alpha.Scorecards.EvaluationInterval value) {
      if (value == null) {
    ...
    // @@protoc_insertion_point(builder_scope:api.v0alpha.ScorecardsPreferences)
  }

  // @@protoc_insertion_point(class_scope:api.v0alpha.ScorecardsPreferences)
  private static final com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences();
  }

  public static com.tcn.cloud.api.api.v0alpha.ScorecardsPreferences getDefaultInstance() {
