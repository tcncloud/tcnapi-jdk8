...
public interface DuplicatePluginInstanceResOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.integrations.DuplicatePluginInstanceRes)
