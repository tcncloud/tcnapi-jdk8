...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.tcn.cloud.api.api.v0alpha.PanelSource.Builder subBuilder = null;
            if (panelSource_ != null) {
              subBuilder = panelSource_.toBuilder();
            }
            panelSource_ = input.readMessage(com.tcn.cloud.api.api.v0alpha.PanelSource.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom(panelSource_);
              panelSource_ = subBuilder.buildPartial();
            }
  ...
  public static final class Builder extends
    ...
    public com.tcn.cloud.api.api.v0alpha.DashboardPanel buildPartial() {
      ...
      if (panelSourceBuilder_ == null) {
        result.panelSource_ = panelSource_;
      } else {
        result.panelSource_ = panelSourceBuilder_.build();
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.tcn.cloud.api.api.v0alpha.DashboardPanel parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.tcn.cloud.api.api.v0alpha.DashboardPanel) e.getUnfinishedMessage();
     ...
     */
    public boolean hasPanelSource() {
      return panelSourceBuilder_ != null || panelSource_ != null;
    }
    /**
     * <pre>
     * panel_source determines the fields needed to
    ...
    public Builder mergePanelSource(com.tcn.cloud.api.api.v0alpha.PanelSource value) {
      if (panelSourceBuilder_ == null) {
        if (panelSource_ != null) {
          panelSource_ =
            com.tcn.cloud.api.api.v0alpha.PanelSource.newBuilder(panelSource_).mergeFrom(value).buildPartial();
        } else {
          panelSource_ = value;
        }
        onChanged();
  ...
  private static final com.google.protobuf.Parser<DashboardPanel>
    ...
    public DashboardPanel parsePartialFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new DashboardPanel(input, extensionRegistry);
    }
  };
