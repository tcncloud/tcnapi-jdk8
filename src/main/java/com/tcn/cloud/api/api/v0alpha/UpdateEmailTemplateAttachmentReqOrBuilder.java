...
public interface UpdateEmailTemplateAttachmentReqOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v0alpha.UpdateEmailTemplateAttachmentReq)
