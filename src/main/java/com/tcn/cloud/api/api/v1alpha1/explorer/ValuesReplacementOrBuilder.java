...
public interface ValuesReplacementOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.v1alpha1.explorer.ValuesReplacement)
   ...
   */
  com.tcn.cloud.api.api.v1alpha1.explorer.ExpressionNode getReplacementValue();
  /**
   * <pre>
   * Result of the replacement
   * </pre>
   ...
   * <code>.api.v1alpha1.explorer.ExpressionNode replacement_value = 3 [json_name = "replacementValue"];</code>
   */
  com.tcn.cloud.api.api.v1alpha1.explorer.ExpressionNodeOrBuilder getReplacementValueOrBuilder();
}
