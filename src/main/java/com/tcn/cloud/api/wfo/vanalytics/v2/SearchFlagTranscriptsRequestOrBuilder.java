...
public interface SearchFlagTranscriptsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:wfo.vanalytics.v2.SearchFlagTranscriptsRequest)
   ...
   * @return The flagSid.
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.FlagSid getFlagSid();
  /**
   * <pre>
   * Optional. Filter by flag sid.
   * </pre>
   ...
   * <code>.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.FlagSid flag_sid = 5 [json_name = "flagSid"];</code>
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.FlagSidOrBuilder getFlagSidOrBuilder();
   ...
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.FlagReviewStatus getFlagReviewStatus();
   ...
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.NotifyGroupId getNotifyGroupId();
  /**
   * <pre>
   * Optional. Filter by notify group id.
   * </pre>
   ...
   * <code>.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.NotifyGroupId notify_group_id = 7 [json_name = "notifyGroupId"];</code>
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.NotifyGroupIdOrBuilder getNotifyGroupIdOrBuilder();
   ...
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.ReviewGroupId getReviewGroupId();
  /**
   * <pre>
   * Optional. Filter by review group id.
   * </pre>
   ...
   * <code>.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.ReviewGroupId review_group_id = 8 [json_name = "reviewGroupId"];</code>
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.SearchFlagTranscriptsRequest.ReviewGroupIdOrBuilder getReviewGroupIdOrBuilder();
