...
public interface FlagOrBuilder extends
    // @@protoc_insertion_point(interface_extends:wfo.vanalytics.v2.Flag)
   ...
   * @return The boolExpr.
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.Flag.BoolExpr getBoolExpr();
  /**
   * <pre>
   * Required. Boolean expression of filters which a transcript must match
   * for this flag to be applied.
   ...
   * <code>.wfo.vanalytics.v2.Flag.BoolExpr bool_expr = 11 [json_name = "boolExpr"];</code>
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.Flag.BoolExprOrBuilder getBoolExprOrBuilder();
   ...
   */
  java.util.List<com.tcn.cloud.api.wfo.vanalytics.v2.DnclList> 
      getDnclListList();
  /**
   * <pre>
   * Optional. Specifies dncl lists to update
   ...
   * <code>repeated .wfo.vanalytics.v2.DnclList dncl_list = 12 [json_name = "dnclList"];</code>
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.DnclList getDnclList(int index);
  /**
   * <pre>
   * Optional. Specifies dncl lists to update
   * if a transcript is flagged.
   ...
   * <code>repeated .wfo.vanalytics.v2.DnclList dncl_list = 12 [json_name = "dnclList"];</code>
   */
  java.util.List<? extends com.tcn.cloud.api.wfo.vanalytics.v2.DnclListOrBuilder> 
   ...
   * <code>repeated .wfo.vanalytics.v2.DnclList dncl_list = 12 [json_name = "dnclList"];</code>
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.DnclListOrBuilder getDnclListOrBuilder(
      int index);
}
