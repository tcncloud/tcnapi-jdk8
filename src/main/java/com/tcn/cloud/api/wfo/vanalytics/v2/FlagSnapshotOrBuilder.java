...
public interface FlagSnapshotOrBuilder extends
    // @@protoc_insertion_point(interface_extends:wfo.vanalytics.v2.FlagSnapshot)
   ...
   * @return The boolExpr.
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.FlagSnapshot.BoolExpr getBoolExpr();
  /**
   * <pre>
   * Required. Boolean expression of filters which a transcript must match
   * for this flag to be applied.
   ...
   * <code>.wfo.vanalytics.v2.FlagSnapshot.BoolExpr bool_expr = 12 [json_name = "boolExpr"];</code>
   */
  com.tcn.cloud.api.wfo.vanalytics.v2.FlagSnapshot.BoolExprOrBuilder getBoolExprOrBuilder();
