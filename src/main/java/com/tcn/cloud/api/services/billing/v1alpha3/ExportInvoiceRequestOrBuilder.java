...
public interface ExportInvoiceRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:services.billing.v1alpha3.ExportInvoiceRequest)
   ...
   * @return The format.
   */
  com.tcn.cloud.api.services.billing.v1alpha3.InvoiceFormat getFormat();
