...
public interface InvoiceItemOrBuilder extends
    // @@protoc_insertion_point(interface_extends:services.billing.entities.v1alpha3.InvoiceItem)
   ...
   */
  java.util.List<com.tcn.cloud.api.services.billing.entities.v1alpha3.InvoiceItemColumn> 
      getColumnsList();
  /**
   * <code>repeated .services.billing.entities.v1alpha3.InvoiceItemColumn columns = 5 [json_name = "columns"];</code>
   */
  com.tcn.cloud.api.services.billing.entities.v1alpha3.InvoiceItemColumn getColumns(int index);
  /**
   * <code>repeated .services.billing.entities.v1alpha3.InvoiceItemColumn columns = 5 [json_name = "columns"];</code>
   */
  int getColumnsCount();
   ...
   * <code>repeated .services.billing.entities.v1alpha3.InvoiceItemColumn columns = 5 [json_name = "columns"];</code>
   */
  java.util.List<? extends com.tcn.cloud.api.services.billing.entities.v1alpha3.InvoiceItemColumnOrBuilder> 
      getColumnsOrBuilderList();
  /**
   * <code>repeated .services.billing.entities.v1alpha3.InvoiceItemColumn columns = 5 [json_name = "columns"];</code>
   */
  com.tcn.cloud.api.services.billing.entities.v1alpha3.InvoiceItemColumnOrBuilder getColumnsOrBuilder(
      int index);
