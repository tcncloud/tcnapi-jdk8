...
public interface InvoiceOrBuilder extends
    // @@protoc_insertion_point(interface_extends:services.billing.entities.v1alpha4.Invoice)
   ...
   */
  java.util.List<com.tcn.cloud.api.services.billing.entities.v1alpha4.InvoiceRow> 
      getRowsList();
  /**
   * <code>repeated .services.billing.entities.v1alpha4.InvoiceRow rows = 3 [json_name = "rows"];</code>
   */
  com.tcn.cloud.api.services.billing.entities.v1alpha4.InvoiceRow getRows(int index);
  /**
   * <code>repeated .services.billing.entities.v1alpha4.InvoiceRow rows = 3 [json_name = "rows"];</code>
   */
  int getRowsCount();
   ...
   * <code>repeated .services.billing.entities.v1alpha4.InvoiceRow rows = 3 [json_name = "rows"];</code>
   */
  java.util.List<? extends com.tcn.cloud.api.services.billing.entities.v1alpha4.InvoiceRowOrBuilder> 
      getRowsOrBuilderList();
  /**
   * <code>repeated .services.billing.entities.v1alpha4.InvoiceRow rows = 3 [json_name = "rows"];</code>
   */
  com.tcn.cloud.api.services.billing.entities.v1alpha4.InvoiceRowOrBuilder getRowsOrBuilder(
      int index);
