...
public interface CommonLanguageSettingsOrBuilder extends
   ...
   * </pre>
   *
   * <code>string reference_docs_uri = 1 [json_name = "referenceDocsUri", deprecated = true];</code>
   * @deprecated google.api.CommonLanguageSettings.reference_docs_uri is deprecated.
   *     See google/api/client.proto;l=122
   ...
   * </pre>
   *
   * <code>repeated .google.api.ClientLibraryDestination destinations = 2 [json_name = "destinations"];</code>
